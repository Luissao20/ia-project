...
export default function Automations() {
    ...
    return (
        ...
        className="grid grid-cols-1 lg:grid-cols-3 p-1 gap-2 lg:p-10 lg:gap-16"
        >
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    src="/sales.svg"
                    alt="sales"
                    width={70}
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Sales and Marketing Automation</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Image, Voice, Text Recognition and Analysis</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Predictive Analytics</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Conversational AI</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Management Automation</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Staff Augmentation</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Data Silos Management</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">Customer Service Automation</h4>
            ...
            <div className="flex flex-col p-1 lg:p-3 gap-3 items-center justify-center w-[350px] lg:w-[400px] border-2 border-[#345d87] rounded-2xl lg:transition lg:duration-300 lg:hover:scale-[1.03] lg:hover:rounded-2xl lg:hover:border-2 lg:hover:border-[#345d87] lg:hover:shadow-xl">
                <Image 
                    ...
                    height={70}
                />
                <h4 className="pt-5 text-lg font-bold text-center text-[#010817]">App Integration</h4>
