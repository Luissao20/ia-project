...
export default function Automations() {
    ...
    return (
        ...
        className="grid grid-cols-3 p-16 gap-16"
        >
            <div className="flex flex-col p-3 gap-3 items-center justify-center w-[400px] border border-transparent rounded-2xl transition duration-300 hover:scale-[1.03] hover:rounded-2xl hover:border hover:border-[#594A28] hover:shadow-xl">
                <Image 
                    src="/sales.svg"
                    alt="sales"
                    width={70}
