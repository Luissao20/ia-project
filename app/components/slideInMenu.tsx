...
export default function SlideMenu({ handleClick }: SlideMenuProps) {
  return (
    <ul className="fixed font-semibold backdrop-blur-sm top-[10vh] z-20 p-10 h-[100vh] w-screen text-white text-3xl flex flex-col gap-8 bg-black/60 animate-slide-in-menu">
      ...
      <li onClick={handleClick}><Link href="/services">Our Services</Link></li>
      <li onClick={handleClick}><Link href="/case-studies">Case Studies</Link></li>
      <li onClick={handleClick}><Link href="/why-agentify">Why Agentify</Link></li>
      <li onClick={handleClick}><Link href="/resources">Resources</Link></li>
    </ul>
  )
}