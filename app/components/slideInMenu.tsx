...
export default function SlideMenu({ handleClick }: SlideMenuProps) {
  return (
    <ul className="fixed font-semibold backdrop-blur-sm top-[12vh] z-20 p-10 h-[100vh] w-screen text-white text-3xl flex flex-col gap-8 bg-[#000000]/60 animate-slide-in-menu">
      ...
      <li onClick={handleClick}><Link href="/features">Features</Link></li>
      <li onClick={handleClick}><Link href="/use-cases">Use Cases</Link></li>
