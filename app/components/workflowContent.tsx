...
export default function WorkflowContent() {
    return (
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-4 z-2 flex justify-center lg:gap-10 lg:-mt-24">
            <div className="flex flex-col items-center gap-3">
                ...
                <p className="select-none text-center w-[300px] lg:w-[400px]">We create a detailed visual blueprint of your existing systems, manual workflows, and apps to identify inefficiencies, save time, and reduce operational costs. This process helps uncover automation opportunities that boost productivity.</p>
            </div>
            <div className="flex flex-col items-center gap-3">
                ...
                <p className="select-none text-center w-[300px] lg:w-[400px]">Our team evaluates your workflows to identify repetitive tasks in areas like marketing, customer service, or operations. We focus on high-impact AI automation opportunities that deliver measurable ROI and improve efficiency.</p>
            </div>
            <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex flex-col items-center gap-3">
                ...
                <p className="select-none text-center w-[300px] lg:w-[400px]">We provide ongoing automation management and optimization, ensuring your workflows evolve with your business. By uncovering new automation opportunities, we help reduce costs, enhance efficiency, and drive continuous business growth.</p>
            </div>
        </div>
    );
}