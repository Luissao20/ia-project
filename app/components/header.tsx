...
export default function Header() {
  ...
  return (
    ...
    <section className="relative text-[#00FFFE] lg:h-[86vh] lg:p-20">
      <ParticlesBackground />
      <Image
        src='/bg.jpg'
        fill
      ...
      <div className="flex flex-col gap-5 lg:flex lg:flex-col lg:gap-20 lg:items-center lg:p-10 lg:pt-32">
        <h1 className="text-4xl font-bold lg:text-6xl lg:backdrop-blur-2xl lg:rounded-2xl" data-aos="flip-up">Empowering Your Business with Smarter AI Agents</h1>
