...
export default function Header() {
  ...
  return (
    ...
    <section className="relative text-white lg:h-[86vh] flex flex-col items-center h-[86vh] lg:flex lg:flex-col lg:items-center border-2 border-[#594A28]">
      <ParticlesBackground />
      <Image
        src="/bg.png"
        fill
        ...
        quality={100}
      />
      <div className="flex flex-col gap-10 p-10 pt-10 lg:flex lg:flex-col lg:gap-10 lg:p-10 lg:pt-40 lg:w-[900px] lg:items-center" data-aos="flip-up">
