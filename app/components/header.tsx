  ...
  return (
    ...
    <section className="relative text-white flex flex-col items-center bg-[url(../public/new-bg.png)] bg-cover bg-no-repeat h-svh">
      ...
      <div className="flex flex-col gap-12 z-8 pt-28 lg:gap-15 lg:p-10 lg:pt-56 items-center" data-aos="flip-up">
        ...
        <h2 className="text-xl lg:text-3xl text-center select-none w-[290px] lg:w-[900px]">Agentify&apos;s Now AI automation solutions, including AI agents and chatbots, help businesses streamline workflows, reduce costs, and improve team productivity—all tailored to fit your growth strategy.</h2>
        <Link href="/contact">
