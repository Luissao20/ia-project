...
export default function Cta() {
    return (
        <div className="flex gap-5 items-center border-2 border-[#345b87] bg-gradient-to-b from-[#03a7b3] to-[#345d87] p-5 m-3 rounded-2xl">
            <span className="lg:text-2xl text-lg text-[#010817]">Need an Automation?</span>
