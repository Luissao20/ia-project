        ...
        <section className="py-20 px-5 flex flex-col items-center justify-center">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="overflow-x-auto">
                    <table className="w-[500px] bg-white border-2 border-[#293750] table-fixed pr-28">
                        <thead className="text-[#1c5a6c] font-bold">
                            <tr>
                        ...
                        <tbody className="text-[#273950]">
                            <tr>
                                <td className="border px-4 py-2" data-aos="fade-right" data-aos-delay="100">Tailored Solutions</td>
                                <td className="border px-4 py-2" data-aos="fade-up" data-aos-delay="200">✅</td>
                            ...
                            <tr>
                                ...
                                <td className="border px-4 py-2" data-aos="fade-up" data-aos-delay="300">✅</td>
                                <td className="border px-4 py-2" data-aos="fade-up" data-aos-delay="400">⚠️</td>
                            </tr>
                            <tr>
