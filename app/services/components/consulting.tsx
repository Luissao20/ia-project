        ...
        <section className="flex flex-col items-center w-full gap-10 pt-10" data-aos="fade-up">
            ...
            <div className="grid grid-cols-2 gap-20 p-20">
                <div className="flex items-center justify-center gap-10 col-span-2">
                    <h4 className="p-20 rounded-r-lg rounded-full border-2 border-[#b0a9cb] bg-gradient-to-b from-[#03a7b3] to-[#010817] bg-clip-text text-transparent text-xl font-bold">Process Automation</h4>
                ...
                <div className="flex items-center justify-center gap-10 col-span-2">
                    ...
                    <h4 className="p-20 rounded-l-lg rounded-full border-2 border-[#010817] bg-gradient-to-b from-[#03a7b3] to-[#010817] bg-clip-text text-transparent text-xl font-bold">Implementation of CRMs</h4>
                </div>
                <div className="flex items-center justify-center gap-10 col-span-2">
                    <h4 className="p-20 rounded-r-lg rounded-full border-2 border-[#3c4442] bg-gradient-to-b from-[#03a7b3] to-[#010817] bg-clip-text text-transparent text-xl font-bold">Lead Generation</h4>
                ...
                <div className="flex items-center justify-center gap-10 col-span-2">
                    ...
                    <h4 className="p-20 rounded-l-lg rounded-full border-2 border-[#03a7b3] bg-gradient-to-b from-[#03a7b3] to-[#010817] bg-clip-text text-transparent text-xl font-bold">Sales and Payment Automation</h4>
                </div>
            </div>
        </section>
    );
