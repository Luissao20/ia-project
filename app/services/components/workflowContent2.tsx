...
export default function WorkflowContent2() {
    return (
        <div className="grid grid-cols-4 z-2 gap-10 p-10 absolute lg:top-40 flex gap-10 -ml-44">
            <div className="flex flex-col items-center gap-3">
                ...
                <span className="pl-4 text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#1c5a6c] to-[#5ca9b1]">Step 1</span>
            ...
            <div className="flex flex-col items-center gap-3">
                ...
                <span className="pl-4 text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#1c5a6c] to-[#5ca9b1]">Step 2</span>
            ...
            <div className="flex flex-col items-center gap-3">
                ...
                <span className="pl-4 text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#1c5a6c] to-[#5ca9b1]">Step 3</span>
            ...
            <div className="flex flex-col items-center gap-3">
                ...
                <span className="pl-4 text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#1c5a6c] to-[#5ca9b1]">Step 4</span>
