  ...
  return (
    <section className="lg:flex lg:flex-col lg:items-center lg:gap-10 lg:pt-5 lg:h-full lg:w-full">
      ...
      <div className="grid items-center grid-cols-2 flex p-10 pl-20 gap-10 w-full h-[1300px] bg-sky-950">
        <div className="relative w-[825px] h-[600px] rounded-[10px] shadow-[16px_16px_20px_#0000008c]
          overflow-hidden 
          ...
          <div className="absolute flex flex-col gap-10 items-center top-[5px] bottom-[5px] left-[5px] right-[5px] rounded-[10px] bg-white shadow-[20px_20px_20px_#0000008c_inset] bg-[url(../public/rb_23189.png)] bg-cover bg-no-repeat">
        ...
        <div className="relative w-[825px] h-[600px] rounded-[10px] shadow-[16px_16px_20px_#0000008c]
          ...
          before:bg-[conic-gradient(transparent,#594A28,#00a6ff)]
          before:animate-spin-slow">
          <div className="absolute flex flex-col items-center gap-10 top-[5px] bottom-[5px] left-[5px] right-[5px] rounded-[10px] bg-white shadow-[20px_20px_20px_#0000008c_inset] bg-[url(../public/673.png)] bg-cover bg-no-repeat">
        ...
        <div className="relative w-[825px] h-[600px] rounded-[10px] shadow-[16px_16px_20px_#0000008c]
          ...
          before:bg-[conic-gradient(transparent,#594A28,#00a6ff)]
          before:animate-spin-slow">
          <div className="absolute flex flex-col items-center gap-10 top-[5px] bottom-[5px] left-[5px] right-[5px] rounded-[10px] bg-white shadow-[20px_20px_20px_#0000008c_inset] bg-[url(../public/rb_4182.png)] bg-cover bg-no-repeat">
        ...
        <div className="relative w-[825px] h-[600px] rounded-[10px] shadow-[16px_16px_20px_#0000008c]
          ...
          before:bg-[conic-gradient(transparent,#594A28,#00a6ff)]
          before:animate-spin-slow">
          <div className="absolute flex flex-col items-center gap-5 top-[5px] bottom-[5px] left-[5px] right-[5px] rounded-[10px] bg-white shadow-[20px_20px_20px_#0000008c_inset] bg-[url(../public/rb_5102.png)] bg-cover bg-no-repeat">
