    ...
    <section className="pt-52 pb-20 px-5 xl:pt-64">
      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-16 lg:flex-row lg:gap-5">
        ...
        <div className="md:px-20 lg:px-0" data-aos="fade-up" data-aos-delay="200">
          <h2 className="text-4xl font-bold text-center mb-8 bg-gradient-to-r from-cyan-700 to-sky-700 text-transparent bg-clip-text">
            Mission
          </h2>
          <div className="p-5 flex flex-col items-center border-2 border-[#594A28] rounded-lg">
            <Image
